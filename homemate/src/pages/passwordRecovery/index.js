...
import {PASSWORD_RECOVERY_EMAIL, PASSWORD_RECOVERY_CODE, PASSWORD_RECOVERY_CHANGE} from '../../utils/constants'
...
function PasswordRecovery({ showNavbar }) {
    ...
    switch (recoveryPage) {
      case PASSWORD_RECOVERY_EMAIL:
        contentForm = <Email setState={setRecoveryPage} email={email} setEmail={setEmail}></Email>;
        break;
      case PASSWORD_RECOVERY_CODE:
        contentForm = <Code setState={setRecoveryPage} email={email}></Code>;
        break;
      case PASSWORD_RECOVERY_CHANGE:
        contentForm = <ChangePassword></ChangePassword>;
        break;
      default:
        break;
    }
        ...
        <div className="homepage-background">
            <Flex styles={{ width: '50%', margin: '0 auto' }}>
                <img
                    ...
                    alt="homemate's logo"
                />
                <SelectedBar styles={{ top: '160px' }}>
                    {recoveryPage}
                </SelectedBar>

                <Flex styles={{ width: '50%', marginTop: '100px' }}>
                    {contentForm}
                </Flex>
            </Flex>
        </div>
